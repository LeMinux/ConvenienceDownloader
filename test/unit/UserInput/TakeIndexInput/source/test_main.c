...
int main(void){
    const struct CMUnitTest take_index_input_group [] = {
        ...
        cmocka_unit_test(testTakeIndexInputVeryLongInputJustNumbers),
        cmocka_unit_test(testTakeIndexInputNumberPaddedOutOfRange),
        cmocka_unit_test(testTakeIndexInput10Spaces),
