...
int main(void){
    const struct CMUnitTest take_depth_input_group [] = {
        ...
        cmocka_unit_test(testTakeDepthInputVeryLongInputJustNumbers),
        cmocka_unit_test(testTakeDepthInputNumberPaddedOutOfRange),
        cmocka_unit_test(testTakeDepthInput10Spaces),
